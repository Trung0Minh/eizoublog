      ...
      <main className="flex-1 w-full max-w-[1440px] mx-auto px-5 md:pt-4 pb-20">
        <div className="flex flex-col lg:flex-row lg:justify-between gap-12 lg:gap-12">
          ...
          <div className="flex-1 w-full lg:max-w-[72%] flex flex-col gap-7 md:gap-10">
            {POSTS.map((post) => (
              <article key={post.id} className="group flex flex-col bg-subtle/30 p-4 border-[2px] border-transparent hover:border-border hover:shadow-lg rounded-[16px] transition-all duration-300">
            ...
            <div className="flex items-center justify-center gap-2 mt-8 md:mt-12">
              <button className="w-8 h-8 rounded-full bg-primary text-background text-[13px] font-medium flex items-center justify-center">1</button>
              <button className="w-8 h-8 rounded-full hover:bg-subtle text-primary text-[13px] font-medium flex items-center justify-center">2</button>
              <button className="w-8 h-8 rounded-full hover:bg-subtle text-primary text-[13px] font-medium flex items-center justify-center">3</button>
              <span className="text-secondary tracking-widest px-1">...</span>
              <button className="w-8 h-8 rounded-full hover:bg-subtle text-primary text-[13px] font-medium flex items-center justify-center">12</button>
            </div>
          </div>
