...
const createSchema = z.object({
  ...
  excerptContent: z.record(z.string(), z.unknown()).optional(),
    ...
    const post = await prisma.$transaction(async (tx) => {
      ...
      const created = await tx.post.create({
        data: {
          ...
          excerptContent: data.excerptContent as Prisma.InputJsonObject | undefined,
      ...
      const snapshot: PostRecoverySnapshot = {
        ...
        excerptContent: (data.excerptContent ?? null) as Prisma.JsonValue | null,
